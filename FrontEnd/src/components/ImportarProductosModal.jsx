...
import { importarProductos } from "../api/peticiones";

const ImportarProductosModal = ({ show, onClose, onImportComplete }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await importarProductos(file, abortControllerRef.current.signal);
      ...
      <div className="modal-content">
        ...
        <div className="import-section">
          <div className="alert alert-info mb-3">
            ...
            <ul>
              <li>Código interno: obligatorio y único</li>
              <li>Nombre del producto: obligatorio</li>
              <li>Tipo de producto: debe existir en el sistema</li>
              <li>Para equipos de cómputo: PLACA SENA y SERIAL deben ser únicos si se proporcionan</li>
              <li>Estado: debe ser 'Disponible', 'En préstamo', 'En mantenimiento' o 'Dado de baja'</li>
              <li>Marca y Observaciones: opcionales</li>
            </ul>
          </div>
              ...
              <div className="results-section">
                ...
                {progress.success > 0 && (
                  <div className="alert alert-success">
                    <strong>✅ {progress.success} productos fueron importados exitosamente</strong>
                  </div>
                )}
              </div>
            )}
